...
export default function Button({text, type, action, icon}) {
    ...
    useLayoutEffect(() => {
        switch (type) {
            ...
            case "underline":
                ...
                break;
            case "quad":
                setButtonClasses("min-w-[32px] min-h-[32px] mr-2 flex justify-center items-center border p-1");
                break;
            case "quad-active":
                setButtonClasses("min-w-[32px] min-h-[32px] mr-2 flex justify-center items-center border-2 border-black p-1");
                break;
            case "disable":
